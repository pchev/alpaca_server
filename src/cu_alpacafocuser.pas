...
begin
  ...
  //curl -X PUT "https://virtserver.swaggerhub.com/ASCOMInitiative/api/v1/focuser/0/move" -H  "accept: application/json" -H  "Content-Type: application/x-www-form-urlencoded" -d "Position=1000&ClientID=0&ClientTransactionID=0"
